...
class UNet2DModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        elif time_embedding_type == "positional":  # default
        ...
        # class embedding
        if class_embed_type is None and num_class_embeds is not None:  # default
        ...
        if mid_block_type is None:
            ...
            self.mid_block = get_mid_block(
                ...
                resnet_groups=self.config.norm_num_groups,
                attn_groups=self.config.attn_norm_num_groups,
                add_attention=self.config.add_attention,
            )
        # up
    ...
    def forward(
        ...
        for downsample_block in self.down_blocks:
            if hasattr(downsample_block, "sekp_conv"):
