    ...
    def forward(
        ...
        **kwargs,
        ...
        if (
            ...
            and isinstance(self.denoising_end)
            ...
            discrete_timestep_cutoff = int(
                round(
                    ...
                    - (self.denosing_end * self.scheduler.config.num_train_timesteps)
                )
            )
...
class StableDiffusionXLImg2ImgPipeline(
    ...
    @torch.no_grad()
    @replace_example_docstring(EXAMPLE_DOC_STRING_IMG2IMG)
    def __call__(
        self,
        prompt: Union[str, List[str]] = None,
        prompt_2: Optional[Union[str, List[str]]] = None,
